...
export default function FeaturedUploadCard() {
  // State to store the uploaded featured media image and file name
  ...
  const handleFileChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (files && files[0]) {
      ...
      if (file instanceof Blob) {
        ...
        // Set the featured media image with the created URL
      ...
      <CardFooter className=" w-auto h-100% bg-slate-200 py-3 my- flex justify-center items-center rounded-none">
        <div className="relative">
          ...
          >
            ...
            {featuredImage ? "Update Featured Media" : "Upload Featured Media"}
          </Button>
        </div>
      </CardFooter>
    </Card>
